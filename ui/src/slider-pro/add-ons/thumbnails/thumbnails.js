...
class Thumbnails extends CustomEventTarget {
    ...
    init() {
        ...
        this.slider.addEventListener( 'beforeInit.' + this.namespace, () => {
            Array.from( this.slider.sliderEl.getElementsByClassName( 'sp-slide' ) ).forEach( ( slideEl, index ) => {
    ...
    updateHandler() {
        ...
        Array.from( this.slider.slidesEl.getElementsByClassName( 'sp-thumbnail' ) ).forEach( ( thumbnailEl, index ) => {
